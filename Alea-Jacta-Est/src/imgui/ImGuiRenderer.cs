...
namespace Alea_Jacta_Est.ImGuiBackend;

/// <summary>ImGui renderer for MonoGame (ported from the official XNA sample).</summary>
public class ImGuiRenderer
{
    ...
    private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
    {
        ...
        for (int n = 0; n < drawData.CmdListsCount; n++)
        {
            ...
            {
                Buffer.MemoryCopy((void*)cmdList.VtxBuffer.Data, vtxDst, _vertexData.Length, cmdList.VtxBuffer.Size * DrawVertDeclaration.Size);
                Buffer.MemoryCopy((void*)cmdList.IdxBuffer.Data, idxDst, _indexData.Length,  cmdList.IdxBuffer.Size  * sizeof(ushort));
            }
        ...
        for (int n = 0; n < drawData.CmdListsCount; n++)
        {
            ...
            for (int cmdi = 0; cmdi < cmdList.CmdBuffer.Size; cmdi++)
            {
                ...
                if (!_loadedTextures.ContainsKey(drawCmd.TextureId))
                    throw new InvalidOperationException($"ImGui texture id '{drawCmd.TextureId}' not found.");
